...
def render_intro(data: Dict[str, Any]) -> Image.Image:
    ...
    base._center(draw, (base._s(540), base._s(455)), loteria.upper(), 112 if len(loteria) <= 13 else 80, (255, 255, 255), True, 3, (0, 0, 0, 175))
    if concurso:
        base._panel(draw, (255, 610, 825, 704), 30, (*primary, 242), (*light, 215), 2)
        base._center(draw, (base._s(540), base._s(657)), f"CONCURSO {concurso}", 41, v5._contrast(primary), True)
    base._center(draw, (base._s(540), base._s(875)), "RESULTADO OFICIAL", 47, (250, 255, 252), True)
    base._center(draw, (base._s(540), base._s(1005)), "APRESENTAÇÃO DOS NÚMEROS", 45, light, True, 2, (0, 0, 0, 150))
    if date:
        base._center(draw, (base._s(540), base._s(1120)), f"SORTEIO DE {date}", 31, (242, 255, 247), True)
    draw.rounded_rectangle((base._s(215), base._s(1350), base._s(865), base._s(1362)), radius=base._s(6), fill=(*primary, 225))
...
def render_reveal_background(data: Dict[str, Any], final: bool = False) -> Image.Image:
    ...
    base._center(draw, (base._s(540), base._s(520)), "RESULTADO COMPLETO" if final else "NÚMEROS SORTEADOS", 36 if final else 31, (245, 255, 249), True)
    if "dupla-sena" in base._slug(loteria) and len(numbers) >= 12:
        for label, y in (("1º SORTEIO", 610), ("2º SORTEIO", 1010)):
            base._panel(draw, (340, y, 740, y + 66), 25, (*primary, 235), (*light, 220), 2)
            base._center(draw, (base._s(540), base._s(y + 33)), label, 29, v5._contrast(primary), True)
    v5._footer(draw, data, light)
    return image.convert("RGB")
...
def render_cta(data: Dict[str, Any]) -> Image.Image:
    ...
    draw = ImageDraw.Draw(image, "RGBA")
    v5._brand(draw, primary, dark, light, bool(data.get("previa", False)))
    base._center(draw, (base._s(540), base._s(365)), loteria.upper(), 75 if len(loteria) <= 16 else 58, light, True, 2, (0, 0, 0, 160))
    base._center(draw, (base._s(540), base._s(520)), "RESULTADO COMPLETO", 68, (255, 255, 255), True, 2, (0, 0, 0, 160))
    base._panel(draw, (155, 720, 925, 855), 42, (*primary, 235), (*light, 205), 2)
    base._center(draw, (base._s(540), base._s(787)), "LINK NA DESCRIÇÃO", 43, v5._contrast(primary), True)
    domain = re.sub(r"^https?://", "", url).split("/")[0] or "www.portalsimonsports.com"
    base._center(draw, (base._s(540), base._s(945)), domain, 32, (245, 255, 249), True)
    labels = (("RESULTADOS", "ATUALIZADOS"), ("FONTE", "OFICIAL"), ("TODAS AS", "LOTERIAS"))
    for index, (line1, line2) in enumerate(labels):
        cx = 220 + index * 320
        draw.ellipse((base._s(cx-56), base._s(1080), base._s(cx+56), base._s(1192)), fill=(*dark, 225), outline=(*light, 205), width=base._s(3))
        base._center(draw, (base._s(cx), base._s(1136)), "✓", 45, light, True)
        base._center(draw, (base._s(cx), base._s(1250)), line1, 20, (255, 255, 255), True)
        base._center(draw, (base._s(cx), base._s(1284)), line2, 20, light, True)
    base._panel(draw, (150, 1430, 930, 1585), 42, (*primary, 225), (*light, 195), 2)
    base._center(draw, (base._s(540), base._s(1478)), "INSCREVA-SE NO CANAL", 36, v5._contrast(primary), True)
    base._center(draw, (base._s(540), base._s(1534)), "E ATIVE AS NOTIFICAÇÕES", 25, v5._contrast(primary), True)
    v5._footer(draw, data, light)
    return image.convert("RGB")
